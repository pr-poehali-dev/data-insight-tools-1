...
const debitCards = [
  ...
  },
  {
    ...
    title: "УБРиР — Дебетовая карта",
    description: "",
    features: [
      "Кешбэк до 6% сразу в четырёх категориях, в том числе и кешбэк на ЖКУ",
      "Максимальный кешбэк — 3000 р. или 5000 р. при подключении подписки «Моя Жизнь+»",
      "10% кешбэк на онлайн-покупки (при подключении подписки «Моя Жизнь+»)",
      "До 35% при совершении покупок у партнёров в разделе «Кешбэк и скидки» в мобильном или интернет-банке УБРиР",
      "Рекомендуйте карту друзьям и получайте вознаграждение в рамках акции «Приведи друга»",
    ...
    link: "https://pxl.leads.su/click/424be9ca70a41ef649487d4a84c370f0?erid=2W5zFHM7JBj",
  },
]
