...
const offers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Несколько тарифных планов под различные категории бизнеса",
      "Резервирование реквизитов сразу после подачи заявки",
      "Интернет-банк и мобильный банк",
      "Бизнес-карты с кешбэком до 10%",
      "Эквайринг от 0,9%",
  ...
  },
  {
    ...
    badgeColor: "bg-blue-500/20 text-blue-400",
    title: "Ozon Банк — РКО",
    description: "Бесплатное открытие и обслуживание счёта от 0 рублей в месяц для бизнеса.",
    features: [
      "До 14,34% годовых с накопительным счётом для бизнеса или до 14,79% с депозитами для бизнеса",
      "Бесплатная онлайн-бухгалтерия — всё для ведения бухгалтерии ИП на УСН «Доходы»",
      "Бесплатные переводы юрлицам в любой банк и снятие наличных",
      "Бесплатное открытие счёта и обслуживание от 0 рублей в месяц",
      "Бесплатный пробный период до конца месяца на всех платных тарифах",
      "Интернет-эквайринг от Ozon Банка — подключите бесплатно, без абонентской платы",
      "Приём платежей для бизнеса с любых карт российских банков",
      "Никаких роботов в поддержке — только люди",
      "Не взимается плата за обслуживание по платным тарифам, если не было движений по счёту",
      "Скидки до 30% с Ozon Картой на Ozon и кэшбэк до 25% на покупки в остальных магазинах",
    ],
    image: "https://cdn.poehali.dev/projects/7f11e639-bdf9-4f98-a1b1-579e441c19f9/files/7f5e7c02-86d7-4685-b4e5-426fa90ec1f2.jpg",
    link: "https://t.fincpanetwork.ru/click/91093/417?erid=2W5zFHbppTA",
  },
  {
    id: 10,
    bank: "Альфа-Банк",
    ...
    description: "Бонусы на развитие бизнеса и выгодные условия по счёту.",
    features: [
      "Бесплатное открытие и обслуживание счёта",
      "Подключение эквайринга и аренда терминалов",
      "Переводы на личный счёт в банке до 100 000 руб./мес. Круглосуточные платежи",
      ...
      "Бесплатная онлайн-бухгалтерия: расчёт налогов и взносов без бухгалтера, отдельный счёт для налоговых накоплений + до 3% на остаток",
      "Торговый эквайринг: бесплатная аренда терминалов, зачисление денег на счёт сразу или на следующий рабочий день",
      "Индикатор риска — поможет не попасть под блокировку интернет-банка или отказ в операции по 115-ФЗ",
    ],
