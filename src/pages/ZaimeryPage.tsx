...
const zaimery = [
  {
    ...
    title: "Займер",
    subtitle: "Первый заём без процентов",
    features: [
  ...
  },
  {
    ...
    title: "MoneyMan",
    subtitle: "Первый онлайн заём бесплатно",
    features: [
    ...
    disclaimer: "ООО МФК «Мани Мен». Полная стоимость займа 0-292% годовых. При своевременном погашении первичного займа на сумму от 1500 до 15000 рублей на срок от 5 до 21 дня полная стоимость займа составит 0%.",
    link: "#",
  },
  {
    id: 3,
    ...
    title: "СрочноДеньги",
    subtitle: "Решение по заявке за 1 минуту",
    features: [
      "Сумма: от 2 000 до 30 000 руб.",
  ...
  },
  {
    ...
    subtitle: "Займ на карту за 15 минут",
    features: [
    ...
    disclaimer: "ПСК 292% годовых. Ставка в день 0,8%. Сумма от 1000 руб. до 30000 руб. Срок от 5 до 30 дней. Валюта: Рубли.",
    link: "#",
  },
  {
    id: 5,
    ...
    title: "БыстроДеньги",
    subtitle: "Первые 10 дней бесплатно",
    features: [
