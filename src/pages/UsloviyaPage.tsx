...
const sections = [
  {
    ...
    items: [
      "Вы оставляете заявку или выбираете продукт на сайте — быстро и без лишних шагов",
      "После оформления с вами связывается банк или сервис — всё официально и прозрачно",
      "Вам назначают удобную дату и сопровождают на всех этапах — ничего не упустите",
      "Готово! Вы получаете продукт без лишних визитов и очередей",
    ],
  },
  {
    icon: Shield,
...
const faq = [
  {
    ...
    a: "Наш сервис абсолютно бесплатен для клиентов.",
  },
  {
  ...
  },
  {
    ...
    a: "В случае отказа, вы можете выбрать альтернативные банки с более мягкими требованиями или поможем устранить причину отказа.",
  },
  {
